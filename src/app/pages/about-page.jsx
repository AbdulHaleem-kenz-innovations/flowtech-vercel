...
const AboutPage = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center" dir={isRtl ? 'rtl' : 'ltr'}>
      ...
      {/* Hero Section */}
      <ScrollFadeIn>
        <section className="pt-[140px] md:pt-[200px] mb-[80px] md:mb-[150px] px-6 w-full sm:w-[98%] max-w-[1260px] mx-auto relative flex flex-col items-center">
      ...
      <section className="px-6 w-full sm:w-[98%] md:max-w-[1310px] mx-auto mb-[80px] md:mb-[150px]">
        <ScrollFadeIn>
          <div className="flex flex-col lg:flex-row gap-[25px]">
            <div className="flex-1 bg-white/5 rounded-[7px] overflow-hidden  relative border border-white/10 group">
      ...
      {/* Core Values Section */}
      <section className="px-6 w-full sm:w-[98%] max-w-[1310px] mx-auto mb-[80px] md:mb-[150px]">
        <ScrollFadeIn>
