        ...
        <div className="flex flex-col lg:flex-row gap-[25px]">
          ...
          <div className="flex-1 backdrop-blur-[10px] bg-white/5 rounded-[7px] p-6 md:p-12 flex flex-col justify-between border border-white/10 relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-6 mt-10 md:mt-12 relative z-10">
              <button className="w-full sm:w-auto bg-gradient-to-r from-[#001ca9] to-[#046ce4] px-8 py-3.5 rounded-full text-white font-['Geist'] text-[14px] uppercase tracking-widest shadow-[0_7px_80px_-12px_rgba(17,15,223,1)] hover:scale-[1.02] transition-transform">
                Meet the team
              </button>
      ...
      <section className="px-6 w-full max-w-[1260px] mx-auto mb-[150px]">
        ...
        <div className="flex flex-col gap-[39px]">
          ...
          <div className="backdrop-blur-[15px] bg-white/5 border border-white/10 rounded-2xl md:rounded-[50px] p-5 md:p-2 md:pr-6 flex flex-col md:flex-row items-center justify-between max-w-[800px] mx-auto w-full mt-4 gap-6 md:gap-4">
            ...
            <button className="w-full md:w-auto bg-gradient-to-r from-[#001ca9] to-[#046ce4] px-8 py-3.5 md:py-3 rounded-full text-white font-['Geist'] text-[14px] uppercase tracking-widest shadow-[0_7px_80px_-12px_rgba(17,15,223,1)] hover:scale-[1.02] active:scale-[0.98] transition-all">
              Contact us
            </button>
          </div>
        </div>
      ...
      <section className="px-6 w-full max-w-[1260px] mx-auto mb-[150px]">
        ...
        <div className="flex flex-col gap-20">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-8 md:gap-10">
            ...
            <button className="w-full sm:w-auto bg-gradient-to-r from-[#001ca9] to-[#046ce4] px-10 py-3.5 rounded-full text-white font-['Geist'] text-[14px] uppercase tracking-widest shadow-[0_7px_80px_-12px_rgba(17,15,223,1)] hover:scale-[1.02] transition-transform">
              Join us
            </button>
          </div>
