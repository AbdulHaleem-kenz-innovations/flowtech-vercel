...
export const ServicesDropdown = ({ isOpen, onClose, anchorRef }) => {
  ...
  }, [anchorRef]); // ← runs once on mount, not gated on isOpen
  ...
  const dropdown = (
    <div
      ...
      onMouseLeave={onClose}
    >
      {/* The glass card — always in the DOM, blur is always composited */}
      <div className="backdrop-blur-[25px] md:bg-white/5 bg-black/40 border border-white/20 rounded-[20px] w-[640px] h-[400px] overflow-hidden flex shadow-2xl">
...
//BLUR WITH RESPECT TO SIDE IMAGE
// export const ServicesDropdown = ({ isOpen, onClose }) => {
//   const [hoveredIndex, setHoveredIndex] = useState(0);
