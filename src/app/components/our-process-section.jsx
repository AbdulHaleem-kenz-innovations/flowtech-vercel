...
const ProcessCard = ({ number, title, ampersandTitle, description, stickyTop }) => (
  <div className="shrink-0 w-full md:w-[682px] md:sticky"
    style={{ top: stickyTop, zIndex: number }}>
    <div className="backdrop-blur-[20px] bg-[rgba(255,255,255,0.07)] relative rounded-[7px] border border-[rgba(255,255,255,0.05)]">
      <div className="content-stretch flex flex-col gap-6 md:gap-[39.2px] items-start justify-center pb-12 md:pb-[60px] pl-6 md:pl-[35px] pr-6 md:pr-[30px] pt-8 md:pt-[30px] relative size-full">
        <div className="content-stretch flex gap-[15px] md:gap-[20px] items-center overflow-clip relative shrink-0 w-full">
          <div className={`backdrop-blur-[10px] ${number === '04' ? 'bg-[rgba(255,255,255,0.1)]' : 'bg-[rgba(255,255,255,0.05)]'} content-stretch flex items-center justify-center pb-[4px] md:pb-[8px] relative rounded-full shrink-0 size-[50px] md:size-[60px]`}>
          ...
          <div className="content-center flex flex-wrap gap-x-2 gap-y-1 items-center overflow-clip relative">
            <span className="bg-clip-text font-['Geist'] font-medium text-[20px] md:text-[23px] text-[transparent] tracking-[-0.4px] leading-tight" style={{ backgroundImage: "linear-gradient(-87.3379deg, rgba(255, 255, 255, 0.4) 5%, rgb(255, 255, 255) 50%)" }}>{title}</span>
            <span className="font-['Playfair_Display'] italic text-[#d9d9d9] text-[20px] md:text-[23px] leading-none">&</span>
            <span className="bg-clip-text font-['Geist'] font-medium text-[20px] md:text-[23px] text-[transparent] tracking-[-0.4px] leading-tight" style={{ backgroundImage: "linear-gradient(-87.3379deg, rgba(255, 255, 255, 0.4) 5%, rgb(255, 255, 255) 50%)" }}>{ampersandTitle}</span>
          </div>
        </div>
        <div className="opacity-75 relative shrink-0 w-full">
          <p className="font-['Geist'] font-normal text-[14px] md:text-[16px] text-white uppercase leading-[1.4] md:leading-[22.4px]">{description}</p>
        </div>
...
export const OurProcessSection = () => {
  return (
    <section className="w-full flex justify-center py-16 md:py-32 px-6 md:px-8 min-h-[250vh]">
      <div className="max-w-[1260px] w-full flex flex-col lg:flex-row gap-12 lg:gap-16 relative" data-name="Our Process ">
        {/* Left Column - Sticky */}
        <div className="w-full lg:w-[500px] flex flex-col gap-8 lg:gap-10 lg:sticky lg:top-32 h-fit">
          ...
          <button className="relative rounded-[800px] w-full sm:w-fit cursor-pointer overflow-hidden group" style={{ backgroundImage: "linear-gradient(42.0662deg, rgb(0, 28, 169) 0%, rgb(4, 108, 228) 100%)" }}>
            <div className="px-8 md:px-[30px] py-4 md:py-[13px] relative z-10 group-hover:scale-105 transition-transform text-center">
              <span className="font-['Geist'] font-medium text-[12px] md:text-[14px] text-white tracking-[0.5px] uppercase whitespace-nowrap">Schedule a consultation</span>
            </div>
        ...
        <div className="flex flex-col gap-6 md:gap-8 w-full lg:w-[682px] pb-[400px]">
          <ProcessCard
            number="01"
            title="Assessment"
