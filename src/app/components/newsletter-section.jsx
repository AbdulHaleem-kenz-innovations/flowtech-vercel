...
import imgImage from "../../assets/news-img.webp";
    ...
    <section className="w-full max-w-[1260px] sm:w-[98%] px-6 py-10 md:py-16 flex flex-col lg:flex-row gap-20 items-center mx-auto" dir={isRtl ? 'rtl' : 'ltr'}>
        ...
        <div className="aspect-[364/470] max-w-[364px] rounded-[7px] overflow-hidden relative group">
          ...
          {/* <div className="absolute bottom-6 start-6 text-start">
            <div className="flex items-center gap-2">
              ...
              <span className="font-playfair text-[23px] text-white/80 italic">{t.surname}</span>
            </div>
      ...
      <div className="flex-1 flex flex-col gap-8">
        <div className="flex flex-col gap-4">
          ...
          <p className="font-playfair italic text-[44px] text-white/80 leading-none">{t.title_italic}</p>
        </div>
