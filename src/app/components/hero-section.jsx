...
export const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-32 pb-20 md:pt-40 md:pb-32 px-6 md:px-8 overflow-hidden ">
      ...
      {/* <div className="absolute bottom-[-5%] md:bottom-[-10%] left-[-10%] md:left-[10%] w-[200px] md:w-[300px] h-[200px] md:h-[540px] blur-[2px]   rotate-[290deg] opacity-40 md:opacity-100 pointer-events-none">
        <ImageWithFallback
          src={imgImage}
          alt=""
